...
VisualTab:CreateToggle({ Name = "NPC Outlines", CurrentValue = OutlineSettings.NPCs, Callback = function(v) OutlineSettings.NPCs = v end })
VisualTab:CreateToggle({ Name = "Corpse Outlines", CurrentValue = OutlineSettings.Corpses, Callback = function(v) OutlineSettings.Corpses = v end })
VisualTab:CreateToggle({ Name = "Ore Outlines", CurrentValue = OutlineSettings.Ores, Callback = function(v) OutlineSettings.Ores = v end })
VisualTab:CreateToggle({ Name = "Tool Outlines", CurrentValue = OutlineSettings.Tools, Callback = function(v) OutlineSettings.Tools = v end })
VisualTab:CreateToggle({ Name = "Item Outlines", CurrentValue = OutlineSettings.Items, Callback = function(v) OutlineSettings.Items = v end })
VisualTab:CreateSlider({ Name = "Scan Interval", Range = {0.1, 5}, CurrentValue = OutlineSettings.ScanInterval, Callback = function(v) OutlineSettings.ScanInterval = v end })
